...
test('various unmarshalling errors', () => {
  const testCases: readonly [string, 'le' | 'be', 0 | 1, string, string][] = [
    ...
    ['o', 'le', 0, '00 00 00 00 00', 'type=o; assertion-failed=""'],
    ['o', 'le', 0, '02 00 00 00 2f 2f 00', 'type=o; assertion-failed="//"'],
    ['o', 'le', 0, '07 00 00 00 2f 61 5f 42 5f 30 2f 00', 'type=o; assertion-failed="/a_B_0/"'],
    ['o', 'le', 0, '06 00 00 00 2f 61 2d 42 2d 30 00', 'type=o; assertion-failed="/a-B-0"'],
...
test('various marshalling errors', () => {
  const testCases: readonly [string, 'le' | 'be', 0 | 1, unknown, string][] = [
    ...
    ['y', 'le', 0, 'foo', 'type=y; assertion-failed="foo"'],
    ['n', 'le', 0, 'foo', 'type=n; assertion-failed="foo"'],
    ['q', 'le', 0, 'foo', 'type=q; assertion-failed="foo"'],
    ['i', 'le', 0, 'foo', 'type=i; assertion-failed="foo"'],
    ['u', 'le', 0, 'foo', 'type=u; assertion-failed="foo"'],
    ['x', 'le', 0, 'foo', 'type=x; assertion-failed="foo"'],
    ['t', 'le', 0, 'foo', 'type=t; assertion-failed="foo"'],
    ['d', 'le', 0, 'foo', 'type=d; assertion-failed="foo"'],
    ['b', 'le', 0, 'foo', 'type=b; assertion-failed="foo"'],
    ['h', 'le', 0, 'foo', 'type=h; assertion-failed="foo"'],
    ['s', 'le', 0, 42, 'type=s; assertion-failed=42'],

    ['o', 'le', 0, 42, 'type=o; assertion-failed=42'],
    ['o', 'le', 0, '', 'type=o; assertion-failed=""'],
    ['o', 'le', 0, '//', 'type=o; assertion-failed="//"'],
    ['o', 'le', 0, '/a_B_0/', 'type=o; assertion-failed="/a_B_0/"'],
    ['o', 'le', 0, '/a-B-0', 'type=o; assertion-failed="/a-B-0"'],

    ['g', 'le', 0, 42, 'type=g; assertion-failed=42'],

    ['a', 'le', 0, [], 'signature="a"; offset=1; type=a; invalid-element-type'],
    ['az', 'le', 0, [], 'signature="az"; offset=1; type=a; invalid-element-type'],

    ['ay', 'le', 0, {}, 'type=a; assertion-failed={}'],
    ['ay', 'le', 0, ['foo'], 'type=a; type=y=a[0]; assertion-failed="foo"'],
    ...
    ['a{yn}', 'le', 0, [{}], 'type=a; type=e=a[0]; assertion-failed={}'],
    ['a{yn}', 'le', 0, [[]], 'type=a; type=e=a[0]; assertion-failed=[]'],
    ['a{yn}', 'le', 0, [[19, 85], [42]], 'type=a; type=e=a[1]; assertion-failed=[42]'],
    ['a{yn}', 'le', 0, [[19, 85, 'foo']], 'type=a; type=e=a[0]; assertion-failed=[19,85,"foo"]'],
    ['a{yn}', 'le', 0, [['foo', 85]], 'type=a; type=e=a[0]; type=y=e[0]; assertion-failed="foo"'],
    ['a{yn}', 'le', 0, [[19, 'foo']], 'type=a; type=e=a[0]; type=n=e[1]; assertion-failed="foo"'],
    ...
    ['(y)', 'le', 0, [], 'type=r; assertion-failed=[]'],
    ['(y)', 'le', 0, [19, 85], 'type=r; invalid-length=[19,85]; actual=2; expected=1'],
    ['(yy)', 'le', 0, [19], 'type=r; invalid-length=[19]; actual=1; expected=2'],
    ['(yy)', 'le', 0, ['foo', 85], 'type=r; type=y=r[0]; assertion-failed="foo"'],
    ['(yy)', 'le', 0, [19, 'foo'], 'type=r; type=y=r[1]; assertion-failed="foo"'],

    ['v', 'le', 0, [], 'type=v; assertion-failed=[]'],
    ['v', 'le', 0, ['foo'], 'type=v; assertion-failed=["foo"]'],
    ['v', 'le', 0, [19, 85], 'type=v; assertion-failed=[19,85]'],
    ['v', 'le', 0, ['foo', 19, 85], 'type=v; assertion-failed=["foo",19,85]'],
    ['v', 'le', 0, ['foo', 42], 'type=v; signature="foo"; offset=0; expected-complete-type'],
    ['v', 'le', 0, ['nn', 42], 'type=v; signature="nn"; offset=1; expected-end'],
    ['v', 'le', 0, ['s', 42], 'type=v; type=s; assertion-failed=42'],
  ];
